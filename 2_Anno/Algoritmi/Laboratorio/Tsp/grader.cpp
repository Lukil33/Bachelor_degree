...
/*
 * This could be a closure of the signal-handling
 ...
 * the signal-handling function to be a pointer to a function and lambdas are
...
void helpers::setup_time_limit(void) {
    debug_logger << "setup_time_limit:\t\t" << "setup_time_limit() called" << endl;
