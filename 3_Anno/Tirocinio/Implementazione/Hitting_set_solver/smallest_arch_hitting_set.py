...
### Wrapper function
def smallest_arch_hitting_set(connections: set) -> tuple[set, float]:

    start = time.perf_counter()

    # Debug print statement
    print(f"Debug: SA Hitting set construction started.")
    ...
    print(f"Debug: SA Hitting set construction completed.\n")
