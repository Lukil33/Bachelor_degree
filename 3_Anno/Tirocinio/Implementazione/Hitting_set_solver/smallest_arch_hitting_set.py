...
### Wrapper function
def complete_smallest_arch_hitting_set(connections: set) -> tuple[set, float]:
...
### Wrapper function
def partial_smallest_arch_hitting_set(connections: set, not_covered_arches: set, node_appearence: dict) -> tuple[set, float]:
    start = time.perf_counter()
