...
### Wrapper function
def biggest_arch_hitting_set(connections: set) -> tuple[set, float]:

    start = time.perf_counter()

    # Debug print statements
    print(f"Debug: BA Hitting set construction started.")
    ...
    # Debug print statements
    print(f"Debug: BA Hitting set construction completed.\n")
...
def hitting_set_search(connections: set) -> set:
    ...
    # I sort the arches from the largest to the smallest degree 
